function classifier(input) {
  ...
  // generate & setting age of students
  function getStudentAge(arrayOfStudents) {
  ...
  //methods defined to generate properties
  //Oldest
  ...
  //registration Number in ascending order
